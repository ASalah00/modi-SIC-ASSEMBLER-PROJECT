...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader file = new BufferedReader(new FileReader("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\in.txt"));
       ...
       // System.out.println(startDecimal);
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\intermediate.txt"));

        writer.write(Clearprogram);
        writer.close();
        //STORING FORMAT 3 INSTRUCTIONS
        Hashtable<String, Integer> format3 = new Hashtable<String, Integer>();
        format3.put("ADD", 0x18);format3.put("AND", 0x40);format3.put("COMP", 0x28);
        format3.put("DIV", 0x24);format3.put("J", 0x3C);format3.put("JEQ", 0x30);
        format3.put("JGT", 0x34);format3.put("JLT", 0x38);format3.put("LDA", 0x00);
        format3.put("LDCH", 0x50);format3.put("LDL", 0x08);format3.put("LDX", 0x04);
        format3.put("MUL", 0x20);format3.put("OR", 0X44);format3.put("RD", 0xD8);
        format3.put("RSUB", 0x4C);format3.put("STA", 0x0C);format3.put("STCH", 0x54);
        format3.put("STL", 0x14);format3.put("STSW", 0xE8);format3.put("STX", 0x10);
        format3.put("SUB", 0x1C);format3.put("TD", 0xE0);format3.put("TIX", 0x2C);
        format3.put("JSUB", 0x48);format3.put("WD", 0xDC);
        //STORING FORMAT 1 INSTRUCTIONS
        Hashtable<String, Integer> format1 = new Hashtable<String, Integer>();
        format1.put("FIX", 0xC4); format1.put("NORM", 0xC8);
        format1.put("FLOAT", 0xC0); format1.put("SIO", 0xF0);
        format1.put("HIO", 0xF4); format1.put("TIO", 0xF8);
        //READ FROM THE INTERMEDIATE FILE
        BufferedReader intermediate = new BufferedReader(new FileReader("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\intermediate.txt"));
       ...
       //VARIABLE CURRENT LOCATION INDICATES THE MOST RECENT LOCATION FOR INTITIAL VALUE IT HAS THE START VALUE
        ...
        while (scan2.hasNextLine()) {
            ...
            if (format3.containsKey(line[1])) {
               ...
               //CHANGE THE VALUE NEXT TO RESB OR RESW TO INTEGER DECIMAL THEN
                //ADD IT TO THE CURRENT LOCATION AS IT IS THE AMOUNT RESERVER IN MEMORY
        ...
        BufferedWriter writer2 = new BufferedWriter(new FileWriter("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\outpass1.txt"));
    //FILE SYMBOL TABLE TO WRITE INSIDE IT
        BufferedWriter writer3 = new BufferedWriter(new FileWriter("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\SymbTable.txt"));
        ...
        intermediate = new BufferedReader(new FileReader("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\intermediate.txt"));
        ...
        BufferedWriter outpass2 = new BufferedWriter(new FileWriter("C:\\Users\\ALEX STORE\\Desktop\\untitled\\src\\com\\company\\outpass2.txt"));
